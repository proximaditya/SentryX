...
export function Dashboard() {
 ...
 return <><button className="dashboard" onClick={() => setZoom(true)} aria-label="Open command center preview">
  ...
  <div className="camera-view"><img src="https://api.i3international.com/Api/Common/GetImage/PostImage/133294998250006597.png" alt="YOLO object detection surveillance preview" />
...
function DashboardPreview(){ return <div className="preview"><p className="eyebrow">Expanded live view</p><h3>Sector A · Camera 04</h3><img src="https://api.i3international.com/Api/Common/GetImage/PostImage/133294998250006597.png" alt="Expanded YOLO detection feed" /></div> }
